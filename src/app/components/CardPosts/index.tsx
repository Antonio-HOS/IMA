...
export default function CardPosts(props: propsCard) {
  ...
  return (
<div className="w-[360px] h-[380px] md:w-[380px] md:h-[410px] bg-white rounded-[20px] flex flex-col justify-center items-center hover:shadow-2xl hover:scale-110 transition-all duration-500">
